...
const SIGNAL_STOCKS: StockConfig[] = [
  ...
  { symbol: 'BHARTIARTL', yahoo: 'BHARTIARTL.NS', name: 'Bharti Airtel', market: 'IN' },
  { symbol: 'ITC', yahoo: 'ITC.NS', name: 'ITC Ltd', market: 'IN' },
  { symbol: 'LT', yahoo: 'LT.NS', name: 'Larsen & Toubro', market: 'IN' },
  { symbol: 'HINDUNILVR', yahoo: 'HINDUNILVR.NS', name: 'Hindustan Unilever', market: 'IN' },
  { symbol: 'AXISBANK', yahoo: 'AXISBANK.NS', name: 'Axis Bank', market: 'IN' },
  { symbol: 'KOTAKBANK', yahoo: 'KOTAKBANK.NS', name: 'Kotak Mahindra', market: 'IN' },
  { symbol: 'MARUTI', yahoo: 'MARUTI.NS', name: 'Maruti Suzuki', market: 'IN' },
  { symbol: 'SUNPHARMA', yahoo: 'SUNPHARMA.NS', name: 'Sun Pharma', market: 'IN' },
  { symbol: 'TITAN', yahoo: 'TITAN.NS', name: 'Titan Company', market: 'IN' },
  { symbol: 'M&M', yahoo: 'M&M.NS', name: 'Mahindra & Mahindra', market: 'IN' },
  ...
  { symbol: 'AMZN', yahoo: 'AMZN', name: 'Amazon.com', market: 'US' },
  { symbol: 'AMD', yahoo: 'AMD', name: 'Advanced Micro Devices', market: 'US' },
];
